...
export const metadata: Metadata = {
  title: 'StudyAI - Your AI Study Buddy',
  description: 'A comprehensive AI Study Buddy that helps you learn any subject through intelligent Q&A, quizzes, flashcards, and mock exams.',
};
